                ...
                <div className="flex justify-center">
                    <div className=" w-1/3">
                        <form action="" className="text-black text-xl">
                            ...
                            <br />
                            <input type="email" placeholder="Type Email Here" className="w-full rounded-sm p-1 mt-5" />
                            <br />
                            ...
                            <button className=" text-white font-bold p-2 rounded-lg mt-3 bg-blue-800 hover:bg-green-500">Send Message</button>
                        </form>
                    </div>
                </div>
            </div>
